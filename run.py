...
navbar = dbc.NavbarSimple(
    brand='Classifying Mushrooms',
    brand_href='/',
    children=[
        dbc.NavItem(dcc.Link('Model Evolution', href='/models', className='nav-link')),
        dbc.NavItem(dcc.Link('Tree Visualization', href='/predictions', className='nav-link')),
    ],
    sticky='top',
    color='light',
    light=True,
